...
<div class="d-flex vh-100 col-12 col-xl-3 col-lg-3 col-md-3">
  <div class="sidebar bg-light col-12 col-xl-12 col-lg-12 col-md-12" [style.display]="menuVisible ? 'block' : 'none'">
    <div class="navbar-nav flex-column justify-content-between" id='menu'>
      <div id="superior" class="">
        <div class="d-flex flex-column justify-content-center align-content-center align-items-center" id="perfil">
          <a (click)="mostrarMenu()" class="nav-link d-flex flex-column" href="./perfil">
            <img src="{{ asset('assets/pruebaPerfilMenu.png') }}" alt="imagenPerfil">Juan Rodriguez
          </a>
        </div>

        <a (click)="mostrarMenu()" class="nav-link enlace" href="./ordenes" id="enlace">
        ...
        <a (click)="mostrarMenu()" class="nav-link enlace" href="./notificaciones" id="enlace">
      ...
      <a class="nav-link logout" routerLink="">
